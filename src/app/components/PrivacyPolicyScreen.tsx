...
const SECTIONS = [
  {
    icon: <Shield size={18} />,
    title: '信息收集',
    content: 'Verdant Guard 会在您使用我们的服务时收集您主动提供的信息，包括账户注册资料、植物信息、浇水记录等。我们仅收集提供服务所必需的信息。',
  },
  {
    icon: <Lock size={18} />,
    title: '数据存储',
    content: '您的数据安全存储于加密服务器上。我们采用行业标准的安全措施保护您的个人信息，防止未经授权的访问、使用或泄露。',
  },
  {
    icon: <Eye size={18} />,
    title: '信息使用',
    content: '我们使用收集的信息来提供、维护和改进服务，包括植物养护提醒、数据统计分析和个性化用户体验。我们不会将您的信息用于广告推送。',
  },
  {
    icon: <UserCheck size={18} />,
    title: '用户权利',
    content: '您有权访问、修改或删除您的个人数据。如有任何问题或请求，您可以通过帮助与反馈页面联系我们，我们将在30天内予以回复。',
  },
  {
    icon: <FileText size={18} />,
    title: '政策更新',
    content: '我们会定期更新本隐私政策。任何重大变更将通过应用内通知或邮件提前告知。继续使用服务即表示您同意更新后的政策。',
  },
];
    ...
    >
      ...
      <div className="px-5 py-8 text-center">
        ...
        <p className="text-muted-foreground text-xs mt-2 max-w-xs mx-auto">
          本政策阐述了 Verdant Guard 如何收集、使用和保护您的个人信息
        </p>
      </div>
      ...
      <div className="px-5 pb-10 space-y-4">
        ...
        >
          <p className="text-muted-foreground text-xs">最后更新：2024年1月</p>
          <p className="text-muted-foreground text-xs mt-1">Verdant Guard 团队</p>
        </motion.div>
      </div>
    </motion.div>
  );
